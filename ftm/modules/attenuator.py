...
class Attenuator:
    ...
    def get_raw(self):
        ...
        if response_data["status"] == "OK":
            return float(response_data["servo"])
        else:
            raise ConnectionError("Error getting servo value")
    ...
    def get_attenuation(self):
        ...
        if response_data["status"] == "OK":
            return float(response_data["attenuation"])
        else:
            raise ConnectionError("Error getting attenuation")
