...
import commands.scans.efficiency
...
def main():
    ...
    # "scan efficiency" subcommand
    parser_scan_efficiency = scan_subparsers.add_parser("efficiency")
    ...
    parser_scan_efficiency.set_defaults(func=lambda args: commands.scans.efficiency.scan(args.config, args.output))
